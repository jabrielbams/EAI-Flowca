  ...
  return (
    <div style={s.container}>
      <header style={s.header}>
        <h1 style={{ margin: 0, fontSize: '1.5rem' }}>FlowCA Accounting</h1>
        <span style={s.badge}>Journal Entries</span>
      </header>
      <div style={s.main}>
        <div style={s.panel}>
...
const s = {
  ...
  header: { backgroundColor: '#2e7d32', color: 'white', padding: '16px 24px', display: 'flex', alignItems: 'center', gap: 12, boxShadow: '0 2px 4px rgba(0,0,0,0.1)' },
